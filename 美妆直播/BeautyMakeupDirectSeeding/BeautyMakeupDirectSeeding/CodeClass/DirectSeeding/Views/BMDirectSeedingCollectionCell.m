...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _start_timeLabel.font = [UIFont systemFontOfSize:kSmallFont];
        ...
        _live_titleLabel.font = [UIFont systemFontOfSize:kLargeFont];
...
- (void)setModel:(BMDsLiveAndPreviewModel *)model
{
    ...
    [BMRequestManager downLoadButton:_live_coverButton UrlString:model.live_cover];
